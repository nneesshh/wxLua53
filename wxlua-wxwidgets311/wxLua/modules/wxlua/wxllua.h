...
WXDLLIMPEXP_WXLUA LUA_INTEGER LUACALL        wxlua_getintegertype(lua_State* L, int stack_idx);
WXDLLIMPEXP_WXLUA unsigned LUA_INTEGER LUACALL wxlua_getuintegertype(lua_State* L, int stack_idx);
