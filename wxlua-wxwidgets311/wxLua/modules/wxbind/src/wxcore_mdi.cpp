...
static wxLuaArgType s_wxluatypeArray_wxLua_wxMDIParentFrame_Create[] = { &wxluatype_wxMDIParentFrame, &wxluatype_wxWindow, &wxluatype_TNUMBER, &wxluatype_TSTRING, &wxluatype_wxPoint, &wxluatype_wxSize, &wxluatype_TINTEGER, &wxluatype_TSTRING, NULL };
...
static int LUACALL wxLua_wxMDIParentFrame_Create(lua_State *L)
{
    ...
    long style = (argCount >= 7 ? (long)wxlua_getintegertype(L, 7) : wxDEFAULT_FRAME_STYLE | wxVSCROLL | wxHSCROLL);
...
#if (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxLUA_USE_wxPointSizeRect)
static wxLuaArgType s_wxluatypeArray_wxLua_wxMDIParentFrame_constructor1[] = { &wxluatype_wxWindow, &wxluatype_TNUMBER, &wxluatype_TSTRING, &wxluatype_wxPoint, &wxluatype_wxSize, &wxluatype_TINTEGER, &wxluatype_TSTRING, NULL };
...
static int LUACALL wxLua_wxMDIParentFrame_constructor1(lua_State *L)
{
    ...
    // long style = wxDEFAULT_FRAME_STYLE | wxVSCROLL | wxHSCROLL
    long style = (argCount >= 6 ? (long)wxlua_getintegertype(L, 6) : wxDEFAULT_FRAME_STYLE | wxVSCROLL | wxHSCROLL);
    // const wxSize size = wxDefaultSize
...
#if (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxLUA_USE_wxPointSizeRect)
static wxLuaArgType s_wxluatypeArray_wxLua_wxMDIChildFrame_Create[] = { &wxluatype_wxMDIChildFrame, &wxluatype_wxMDIParentFrame, &wxluatype_TNUMBER, &wxluatype_TSTRING, &wxluatype_wxPoint, &wxluatype_wxSize, &wxluatype_TINTEGER, &wxluatype_TSTRING, NULL };
...
static int LUACALL wxLua_wxMDIChildFrame_Create(lua_State *L)
{
    ...
    long style = (argCount >= 7 ? (long)wxlua_getintegertype(L, 7) : wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 6 ? (const wxSize *)wxluaT_getuserdatatype(L, 6, wxluatype_wxSize) : &wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 5 ? (const wxPoint *)wxluaT_getuserdatatype(L, 5, wxluatype_wxPoint) : &wxDefaultPosition);
...
#if (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxLUA_USE_wxPointSizeRect)
static wxLuaArgType s_wxluatypeArray_wxLua_wxMDIChildFrame_constructor1[] = { &wxluatype_wxMDIParentFrame, &wxluatype_TNUMBER, &wxluatype_TSTRING, &wxluatype_wxPoint, &wxluatype_wxSize, &wxluatype_TINTEGER, &wxluatype_TSTRING, NULL };
...
static int LUACALL wxLua_wxMDIChildFrame_constructor1(lua_State *L)
{
    ...
    // long style = wxDEFAULT_FRAME_STYLE
    long style = (argCount >= 6 ? (long)wxlua_getintegertype(L, 6) : wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 5 ? (const wxSize *)wxluaT_getuserdatatype(L, 5, wxluatype_wxSize) : &wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 4 ? (const wxPoint *)wxluaT_getuserdatatype(L, 4, wxluatype_wxPoint) : &wxDefaultPosition);
...
#if ((wxLUA_USE_wxFrame) && (wxLUA_USE_wxPointSizeRect)) && (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE)
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocMDIParentFrame_Create[] = { &wxluatype_wxDocMDIParentFrame, &wxluatype_wxDocManager, &wxluatype_wxFrame, &wxluatype_TNUMBER, &wxluatype_TSTRING, &wxluatype_wxPoint, &wxluatype_wxSize, &wxluatype_TINTEGER, &wxluatype_TSTRING, NULL };
...
static int LUACALL wxLua_wxDocMDIParentFrame_Create(lua_State *L)
{
    ...
    // long style = wxDEFAULT_FRAME_STYLE
    long style = (argCount >= 8 ? (long)wxlua_getintegertype(L, 8) : wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
...
#endif // ((wxLUA_USE_wxFrame) && (wxLUA_USE_wxPointSizeRect)) && (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE)
...
#if ((wxLUA_USE_wxFrame) && (wxLUA_USE_wxPointSizeRect)) && (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE)
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocMDIParentFrame_constructor1[] = { &wxluatype_wxDocManager, &wxluatype_wxFrame, &wxluatype_TNUMBER, &wxluatype_TSTRING, &wxluatype_wxPoint, &wxluatype_wxSize, &wxluatype_TINTEGER, &wxluatype_TSTRING, NULL };
...
#if (((wxLUA_USE_wxFrame) && (wxLUA_USE_wxPointSizeRect)) && (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE))||(wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE)
// function overload table
...
#endif // (((wxLUA_USE_wxFrame) && (wxLUA_USE_wxPointSizeRect)) && (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE))||(wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE)
...
#if (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxLUA_USE_wxPointSizeRect)
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocMDIChildFrame_Create[] = { &wxluatype_wxDocMDIChildFrame, &wxluatype_wxDocument, &wxluatype_wxView, &wxluatype_wxMDIParentFrame, &wxluatype_TNUMBER, &wxluatype_TSTRING, &wxluatype_wxPoint, &wxluatype_wxSize, &wxluatype_TINTEGER, &wxluatype_TSTRING, NULL };
...
static int LUACALL wxLua_wxDocMDIChildFrame_Create(lua_State *L)
{
    ...
    long type = (argCount >= 9 ? (long)wxlua_getintegertype(L, 9) : wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
...
#if (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxLUA_USE_wxPointSizeRect)
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocMDIChildFrame_constructor1[] = { &wxluatype_wxDocument, &wxluatype_wxView, &wxluatype_wxMDIParentFrame, &wxluatype_TNUMBER, &wxluatype_TSTRING, &wxluatype_wxPoint, &wxluatype_wxSize, &wxluatype_TINTEGER, &wxluatype_TSTRING, NULL };
...
static int LUACALL wxLua_wxDocMDIChildFrame_constructor1(lua_State *L)
{
    ...
    // long type = wxDEFAULT_FRAME_STYLE
    long type = (argCount >= 8 ? (long)wxlua_getintegertype(L, 8) : wxDEFAULT_FRAME_STYLE);
    // const wxSize size = wxDefaultSize
    const wxSize * size = (argCount >= 7 ? (const wxSize *)wxluaT_getuserdatatype(L, 7, wxluatype_wxSize) : &wxDefaultSize);
    // const wxPoint pos = wxDefaultPosition
    const wxPoint * pos = (argCount >= 6 ? (const wxPoint *)wxluaT_getuserdatatype(L, 6, wxluatype_wxPoint) : &wxDefaultPosition);
...
#if ((wxLUA_USE_wxFrame) && (wxLUA_USE_wxPointSizeRect)) && (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE)
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocChildFrame_constructor[] = { &wxluatype_wxDocument, &wxluatype_wxView, &wxluatype_wxFrame, &wxluatype_TNUMBER, &wxluatype_TSTRING, &wxluatype_wxPoint, &wxluatype_wxSize, &wxluatype_TINTEGER, &wxluatype_TSTRING, NULL };
...
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_ActivateView[1] = {{ wxLua_wxDocManager_ActivateView, WXLUAMETHOD_METHOD, 2, 3, s_wxluatypeArray_wxLua_wxDocManager_ActivateView }};
...
static int LUACALL wxLua_wxDocManager_ActivateView(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool activate = true
    bool activate = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : true);
    // wxView view
    wxView * view = (wxView *)wxluaT_getuserdatatype(L, 2, wxluatype_wxView);
    // get this
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_Clear[] = { &wxluatype_wxDocManager, &wxluatype_TBOOLEAN, NULL };
static int LUACALL wxLua_wxDocManager_Clear(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_Clear[1] = {{ wxLua_wxDocManager_Clear, WXLUAMETHOD_METHOD, 1, 2, s_wxluatypeArray_wxLua_wxDocManager_Clear }};
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_CloseDocument[] = { &wxluatype_wxDocManager, &wxluatype_wxDocument, &wxluatype_TBOOLEAN, NULL };
static int LUACALL wxLua_wxDocManager_CloseDocument(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_CloseDocument[1] = {{ wxLua_wxDocManager_CloseDocument, WXLUAMETHOD_METHOD, 2, 3, s_wxluatypeArray_wxLua_wxDocManager_CloseDocument }};
...
static int LUACALL wxLua_wxDocManager_CloseDocument(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool force = false
    bool force = (argCount >= 3 ? wxlua_getbooleantype(L, 3) : false);
    // wxDocument doc
    wxDocument * doc = (wxDocument *)wxluaT_getuserdatatype(L, 2, wxluatype_wxDocument);
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call CloseDocument
    bool returns = (self->CloseDocument(doc, force));
    // push the result flag
    lua_pushboolean(L, returns);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_CreateDocument[] = { &wxluatype_wxDocManager, &wxluatype_TSTRING, &wxluatype_TINTEGER, NULL };
static int LUACALL wxLua_wxDocManager_CreateDocument(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_CreateDocument[1] = {{ wxLua_wxDocManager_CreateDocument, WXLUAMETHOD_METHOD, 2, 3, s_wxluatypeArray_wxLua_wxDocManager_CreateDocument }};
...
static int LUACALL wxLua_wxDocManager_CreateDocument(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // long flags = 0
    long flags = (argCount >= 3 ? (long)wxlua_getintegertype(L, 3) : 0);
    // const wxString path
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_CreateNewDocument[] = { &wxluatype_wxDocManager, NULL };
static int LUACALL wxLua_wxDocManager_CreateNewDocument(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_CreateNewDocument[1] = {{ wxLua_wxDocManager_CreateNewDocument, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocManager_CreateNewDocument }};
...
static int LUACALL wxLua_wxDocManager_CreateNewDocument(lua_State *L)
{
    ...
    wxDocument* returns = (wxDocument*)self->CreateNewDocument();
    // push the result datatype
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxDocument);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_CreateView[] = { &wxluatype_wxDocManager, &wxluatype_wxDocument, &wxluatype_TINTEGER, NULL };
static int LUACALL wxLua_wxDocManager_CreateView(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_CreateView[1] = {{ wxLua_wxDocManager_CreateView, WXLUAMETHOD_METHOD, 2, 3, s_wxluatypeArray_wxLua_wxDocManager_CreateView }};
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_DeleteTemplate[] = { &wxluatype_wxDocManager, &wxluatype_wxDocTemplate, &wxluatype_TINTEGER, NULL };
static int LUACALL wxLua_wxDocManager_DeleteTemplate(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_DeleteTemplate[1] = {{ wxLua_wxDocManager_DeleteTemplate, WXLUAMETHOD_METHOD, 2, 3, s_wxluatypeArray_wxLua_wxDocManager_DeleteTemplate }};
...
static int LUACALL wxLua_wxDocManager_DeleteTemplate(lua_State *L)
{
    ...
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call DeleteTemplate
    self->DeleteTemplate(temp, flags);
...
#if ((wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_CONFIG)) && (wxLUA_USE_wxConfig && wxUSE_CONFIG)
...
static int LUACALL wxLua_wxDocManager_FileHistoryLoad(lua_State *L)
{
    ...
    const wxConfigBase * config = (const wxConfigBase *)wxluaT_getuserdatatype(L, 2, wxluatype_wxConfigBase);
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
...
#endif // ((wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_CONFIG)) && (wxLUA_USE_wxConfig && wxUSE_CONFIG)
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_FindDocumentByPath[] = { &wxluatype_wxDocManager, &wxluatype_TSTRING, NULL };
static int LUACALL wxLua_wxDocManager_FindDocumentByPath(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_FindDocumentByPath[1] = {{ wxLua_wxDocManager_FindDocumentByPath, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_FindDocumentByPath }};
...
static int LUACALL wxLua_wxDocManager_FindDocumentByPath(lua_State *L)
{
    ...
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call FindDocumentByPath
    wxDocument* returns = (wxDocument*)self->FindDocumentByPath(path);
    // push the result datatype
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxDocument);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_FindTemplate[] = { &wxluatype_wxDocManager, &wxluatype_wxClassInfo, NULL };
static int LUACALL wxLua_wxDocManager_FindTemplate(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_FindTemplate[1] = {{ wxLua_wxDocManager_FindTemplate, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_FindTemplate }};
//     wxDocTemplate* FindTemplate(const wxClassInfo* documentClassInfo);
static int LUACALL wxLua_wxDocManager_FindTemplate(lua_State *L)
{
    // const wxClassInfo documentClassInfo
    const wxClassInfo * documentClassInfo = (const wxClassInfo *)wxluaT_getuserdatatype(L, 2, wxluatype_wxClassInfo);
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call FindTemplate
    wxDocTemplate* returns = (wxDocTemplate*)self->FindTemplate(documentClassInfo);
    // push the result datatype
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_FlushDoc[] = { &wxluatype_wxDocManager, &wxluatype_wxDocument, NULL };
static int LUACALL wxLua_wxDocManager_FlushDoc(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_FlushDoc[1] = {{ wxLua_wxDocManager_FlushDoc, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_FlushDoc }};
...
static int LUACALL wxLua_wxDocManager_FlushDoc(lua_State *L)
{
    ...
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call FlushDoc
    bool returns = (self->FlushDoc(doc));
    // push the result flag
    lua_pushboolean(L, returns);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_GetAnyUsableView[] = { &wxluatype_wxDocManager, NULL };
static int LUACALL wxLua_wxDocManager_GetAnyUsableView(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_GetAnyUsableView[1] = {{ wxLua_wxDocManager_GetAnyUsableView, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocManager_GetAnyUsableView }};
//     wxView *GetAnyUsableView() const;
static int LUACALL wxLua_wxDocManager_GetAnyUsableView(lua_State *L)
{
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call GetAnyUsableView
    wxView* returns = (wxView*)self->GetAnyUsableView();
    // push the result datatype
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxView);
...
static int LUACALL wxLua_wxDocManager_GetDocumentManager(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_GetDocumentManager[1] = {{ wxLua_wxDocManager_GetDocumentManager, WXLUAMETHOD_METHOD|WXLUAMETHOD_STATIC, 0, 0, g_wxluaargtypeArray_None }};
//     static wxDocManager* GetDocumentManager();
static int LUACALL wxLua_wxDocManager_GetDocumentManager(lua_State *L)
{
    // call GetDocumentManager
    wxDocManager* returns = (wxDocManager*)wxDocManager::GetDocumentManager();
    // push the result datatype
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxDocManager);
...
static int LUACALL wxLua_wxDocManager_GetDocuments(lua_State *L)
{
    ...
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call GetDocuments
    wxObjectList* returns = (wxObjectList*)&self->GetDocuments();
    // push the result datatype
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxObjectList);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_GetHistoryFile[] = { &wxluatype_wxDocManager, &wxluatype_TINTEGER, NULL };
static int LUACALL wxLua_wxDocManager_GetHistoryFile(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_GetHistoryFile[1] = {{ wxLua_wxDocManager_GetHistoryFile, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_GetHistoryFile }};
...
static int LUACALL wxLua_wxDocManager_GetHistoryFile(lua_State *L)
{
    ...
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call GetHistoryFile
    wxString returns = (self->GetHistoryFile(i));
...
#if ((wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_PRINTING_ARCHITECTURE)) && (wxLUA_USE_wxPrint && wxUSE_PRINTING_ARCHITECTURE)
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_GetPageSetupDialogData1[] = { &wxluatype_wxDocManager, NULL };
static int LUACALL wxLua_wxDocManager_GetPageSetupDialogData1(lua_State *L);
// static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_GetPageSetupDialogData1[1] = {{ wxLua_wxDocManager_GetPageSetupDialogData1, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocManager_GetPageSetupDialogData1 }};
...
static int LUACALL wxLua_wxDocManager_GetPageSetupDialogData1(lua_State *L)
{
    ...
    const wxPageSetupDialogData* returns = (const wxPageSetupDialogData*)&self->GetPageSetupDialogData();
    // push the result datatype
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_GetPageSetupDialogData[] = { &wxluatype_wxDocManager, NULL };
static int LUACALL wxLua_wxDocManager_GetPageSetupDialogData(lua_State *L);
// static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_GetPageSetupDialogData[1] = {{ wxLua_wxDocManager_GetPageSetupDialogData, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocManager_GetPageSetupDialogData }};
...
#endif // ((wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_PRINTING_ARCHITECTURE)) && (wxLUA_USE_wxPrint && wxUSE_PRINTING_ARCHITECTURE)
...
static int LUACALL wxLua_wxDocManager_GetTemplates(lua_State *L)
{
    ...
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call GetTemplates
    wxObjectList* returns = (wxObjectList*)&self->GetTemplates();
    // push the result datatype
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxObjectList);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_MakeFrameTitle[] = { &wxluatype_wxDocManager, &wxluatype_wxDocument, NULL };
static int LUACALL wxLua_wxDocManager_MakeFrameTitle(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_MakeFrameTitle[1] = {{ wxLua_wxDocManager_MakeFrameTitle, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_MakeFrameTitle }};
...
static int LUACALL wxLua_wxDocManager_MakeFrameTitle(lua_State *L)
{
    ...
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call MakeFrameTitle
    wxString returns = (self->MakeFrameTitle(doc));
    // push the result string
    wxlua_pushwxString(L, returns);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_MakeNewDocumentName[] = { &wxluatype_wxDocManager, NULL };
static int LUACALL wxLua_wxDocManager_MakeNewDocumentName(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_MakeNewDocumentName[1] = {{ wxLua_wxDocManager_MakeNewDocumentName, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocManager_MakeNewDocumentName }};
//     wxString MakeNewDocumentName();
static int LUACALL wxLua_wxDocManager_MakeNewDocumentName(lua_State *L)
{
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call MakeNewDocumentName
    wxString returns = (self->MakeNewDocumentName());
    // push the result string
    wxlua_pushwxString(L, returns);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_MatchTemplate[] = { &wxluatype_wxDocManager, &wxluatype_TSTRING, NULL };
static int LUACALL wxLua_wxDocManager_MatchTemplate(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_MatchTemplate[1] = {{ wxLua_wxDocManager_MatchTemplate, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_MatchTemplate }};
...
static int LUACALL wxLua_wxDocManager_MatchTemplate(lua_State *L)
{
    ...
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call MatchTemplate
    wxDocTemplate* returns = (wxDocTemplate*)self->MatchTemplate(path);
    // push the result datatype
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxDocTemplate);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnMRUFile[] = { &wxluatype_wxDocManager, &wxluatype_wxCommandEvent, NULL };
static int LUACALL wxLua_wxDocManager_OnMRUFile(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnMRUFile[1] = {{ wxLua_wxDocManager_OnMRUFile, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_OnMRUFile }};
...
static int LUACALL wxLua_wxDocManager_OnMRUFile(lua_State *L)
{
    ...
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call OnMRUFile
    self->OnMRUFile(*event);

    return 0;
}

static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnOpenFileFailure[] = { &wxluatype_wxDocManager, NULL };
static int LUACALL wxLua_wxDocManager_OnOpenFileFailure(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnOpenFileFailure[1] = {{ wxLua_wxDocManager_OnOpenFileFailure, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocManager_OnOpenFileFailure }};
//     void OnOpenFileFailure();
static int LUACALL wxLua_wxDocManager_OnOpenFileFailure(lua_State *L)
{
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call OnOpenFileFailure
...
#if (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_PRINTING_ARCHITECTURE)
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnPageSetup[] = { &wxluatype_wxDocManager, &wxluatype_wxCommandEvent, NULL };
static int LUACALL wxLua_wxDocManager_OnPageSetup(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnPageSetup[1] = {{ wxLua_wxDocManager_OnPageSetup, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_OnPageSetup }};
...
static int LUACALL wxLua_wxDocManager_OnPageSetup(lua_State *L)
{
    ...
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call OnPageSetup
    self->OnPageSetup(*event);

    return 0;
}

static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnPreview[] = { &wxluatype_wxDocManager, &wxluatype_wxCommandEvent, NULL };
static int LUACALL wxLua_wxDocManager_OnPreview(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnPreview[1] = {{ wxLua_wxDocManager_OnPreview, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_OnPreview }};
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnPrint[] = { &wxluatype_wxDocManager, &wxluatype_wxCommandEvent, NULL };
static int LUACALL wxLua_wxDocManager_OnPrint(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnPrint[1] = {{ wxLua_wxDocManager_OnPrint, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_OnPrint }};
...
#endif // (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_PRINTING_ARCHITECTURE)

static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnRedo[] = { &wxluatype_wxDocManager, &wxluatype_wxCommandEvent, NULL };
static int LUACALL wxLua_wxDocManager_OnRedo(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnRedo[1] = {{ wxLua_wxDocManager_OnRedo, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_OnRedo }};
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnUndo[] = { &wxluatype_wxDocManager, &wxluatype_wxCommandEvent, NULL };
static int LUACALL wxLua_wxDocManager_OnUndo(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnUndo[1] = {{ wxLua_wxDocManager_OnUndo, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_OnUndo }};
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnUpdateDisableIfNoDoc[] = { &wxluatype_wxDocManager, &wxluatype_wxUpdateUIEvent, NULL };
static int LUACALL wxLua_wxDocManager_OnUpdateDisableIfNoDoc(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnUpdateDisableIfNoDoc[1] = {{ wxLua_wxDocManager_OnUpdateDisableIfNoDoc, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_OnUpdateDisableIfNoDoc }};
...
static int LUACALL wxLua_wxDocManager_OnUpdateDisableIfNoDoc(lua_State *L)
{
    ...
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call OnUpdateDisableIfNoDoc
    self->OnUpdateDisableIfNoDoc(*event);

    return 0;
}

static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnUpdateFileNew[] = { &wxluatype_wxDocManager, &wxluatype_wxUpdateUIEvent, NULL };
static int LUACALL wxLua_wxDocManager_OnUpdateFileNew(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnUpdateFileNew[1] = {{ wxLua_wxDocManager_OnUpdateFileNew, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_OnUpdateFileNew }};
...
static int LUACALL wxLua_wxDocManager_OnUpdateFileNew(lua_State *L)
{
    ...
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call OnUpdateFileNew
    self->OnUpdateFileNew(*event);

    return 0;
}

static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnUpdateFileOpen[] = { &wxluatype_wxDocManager, &wxluatype_wxUpdateUIEvent, NULL };
static int LUACALL wxLua_wxDocManager_OnUpdateFileOpen(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnUpdateFileOpen[1] = {{ wxLua_wxDocManager_OnUpdateFileOpen, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_OnUpdateFileOpen }};
...
static int LUACALL wxLua_wxDocManager_OnUpdateFileOpen(lua_State *L)
{
    ...
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call OnUpdateFileOpen
    self->OnUpdateFileOpen(*event);

    return 0;
}

static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnUpdateFileRevert[] = { &wxluatype_wxDocManager, &wxluatype_wxUpdateUIEvent, NULL };
static int LUACALL wxLua_wxDocManager_OnUpdateFileRevert(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnUpdateFileRevert[1] = {{ wxLua_wxDocManager_OnUpdateFileRevert, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_OnUpdateFileRevert }};
...
static int LUACALL wxLua_wxDocManager_OnUpdateFileRevert(lua_State *L)
{
    ...
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call OnUpdateFileRevert
    self->OnUpdateFileRevert(*event);

    return 0;
}

static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnUpdateFileSave[] = { &wxluatype_wxDocManager, &wxluatype_wxUpdateUIEvent, NULL };
static int LUACALL wxLua_wxDocManager_OnUpdateFileSave(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnUpdateFileSave[1] = {{ wxLua_wxDocManager_OnUpdateFileSave, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_OnUpdateFileSave }};
...
static int LUACALL wxLua_wxDocManager_OnUpdateFileSave(lua_State *L)
{
    ...
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call OnUpdateFileSave
    self->OnUpdateFileSave(*event);

    return 0;
}

static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnUpdateFileSaveAs[] = { &wxluatype_wxDocManager, &wxluatype_wxUpdateUIEvent, NULL };
static int LUACALL wxLua_wxDocManager_OnUpdateFileSaveAs(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnUpdateFileSaveAs[1] = {{ wxLua_wxDocManager_OnUpdateFileSaveAs, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_OnUpdateFileSaveAs }};
...
static int LUACALL wxLua_wxDocManager_OnUpdateFileSaveAs(lua_State *L)
{
    ...
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call OnUpdateFileSaveAs
    self->OnUpdateFileSaveAs(*event);

    return 0;
}

static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnUpdateRedo[] = { &wxluatype_wxDocManager, &wxluatype_wxUpdateUIEvent, NULL };
static int LUACALL wxLua_wxDocManager_OnUpdateRedo(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnUpdateRedo[1] = {{ wxLua_wxDocManager_OnUpdateRedo, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_OnUpdateRedo }};
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_OnUpdateUndo[] = { &wxluatype_wxDocManager, &wxluatype_wxUpdateUIEvent, NULL };
static int LUACALL wxLua_wxDocManager_OnUpdateUndo(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_OnUpdateUndo[1] = {{ wxLua_wxDocManager_OnUpdateUndo, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_OnUpdateUndo }};
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_RemoveFileFromHistory[] = { &wxluatype_wxDocManager, &wxluatype_TINTEGER, NULL };
static int LUACALL wxLua_wxDocManager_RemoveFileFromHistory(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_RemoveFileFromHistory[1] = {{ wxLua_wxDocManager_RemoveFileFromHistory, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocManager_RemoveFileFromHistory }};
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_SelectDocumentPath[] = { &wxluatype_wxDocManager, &wxluatype_wxDocTemplate, &wxluatype_TINTEGER, &wxluatype_TSTRING, &wxluatype_TINTEGER, &wxluatype_TBOOLEAN, NULL };
static int LUACALL wxLua_wxDocManager_SelectDocumentPath(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_SelectDocumentPath[1] = {{ wxLua_wxDocManager_SelectDocumentPath, WXLUAMETHOD_METHOD, 5, 6, s_wxluatypeArray_wxLua_wxDocManager_SelectDocumentPath }};
...
static int LUACALL wxLua_wxDocManager_SelectDocumentPath(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool save = false
    bool save = (argCount >= 6 ? wxlua_getbooleantype(L, 6) : false);
    // long flags
    long flags = (long)wxlua_getintegertype(L, 5);
    // wxString path
    wxString path = wxlua_getwxStringtype(L, 4);
    // int noTemplates
    int noTemplates = (int)wxlua_getintegertype(L, 3);
    // wxDocTemplate templates
    wxDocTemplate ** templates = (wxDocTemplate **)wxluaT_getuserdatatype(L, 2, wxluatype_wxDocTemplate);
    // get this
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call SelectDocumentPath
    wxDocTemplate* returns = (wxDocTemplate*)self->SelectDocumentPath(templates, noTemplates, path, flags, save);
    // push the result datatype
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxDocTemplate);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_SelectDocumentType[] = { &wxluatype_wxDocManager, &wxluatype_wxDocTemplate, &wxluatype_TINTEGER, &wxluatype_TBOOLEAN, NULL };
static int LUACALL wxLua_wxDocManager_SelectDocumentType(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_SelectDocumentType[1] = {{ wxLua_wxDocManager_SelectDocumentType, WXLUAMETHOD_METHOD, 3, 4, s_wxluatypeArray_wxLua_wxDocManager_SelectDocumentType }};
...
static int LUACALL wxLua_wxDocManager_SelectDocumentType(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool sort = false
    bool sort = (argCount >= 4 ? wxlua_getbooleantype(L, 4) : false);
    // int noTemplates
    int noTemplates = (int)wxlua_getintegertype(L, 3);
    // wxDocTemplate templates
    wxDocTemplate ** templates = (wxDocTemplate **)wxluaT_getuserdatatype(L, 2, wxluatype_wxDocTemplate);
    ...
    wxDocTemplate* returns = (wxDocTemplate*)self->SelectDocumentType(templates, noTemplates, sort);
    // push the result datatype
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxDocTemplate);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_SelectViewType[] = { &wxluatype_wxDocManager, &wxluatype_wxDocTemplate, &wxluatype_TINTEGER, &wxluatype_TBOOLEAN, NULL };
static int LUACALL wxLua_wxDocManager_SelectViewType(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_SelectViewType[1] = {{ wxLua_wxDocManager_SelectViewType, WXLUAMETHOD_METHOD, 3, 4, s_wxluatypeArray_wxLua_wxDocManager_SelectViewType }};
//             int noTemplates, bool sort = false);
static int LUACALL wxLua_wxDocManager_SelectViewType(lua_State *L)
{
    // get number of arguments
    ...
    wxDocManager * self = (wxDocManager *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocManager);
    // call SelectViewType
    wxDocTemplate* returns = (wxDocTemplate*)self->SelectViewType(templates, noTemplates, sort);
    // push the result datatype
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxDocTemplate);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_SetMaxDocsOpen[] = { &wxluatype_wxDocManager, &wxluatype_TINTEGER, NULL };
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocManager_constructor[] = { &wxluatype_TINTEGER, &wxluatype_TBOOLEAN, NULL };
...
static int LUACALL wxLua_wxDocManager_constructor(lua_State *L)
{
    ...
    // long flags = 0
    long flags = (argCount >= 1 ? (long)wxlua_getintegertype(L, 1) : 0);
    // call constructor
...
#if (((wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_PRINTING_ARCHITECTURE)) && (wxLUA_USE_wxPrint && wxUSE_PRINTING_ARCHITECTURE))
// function overload table
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocManager_GetPageSetupDialogData_overload[] =
{

#if ((wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_PRINTING_ARCHITECTURE)) && (wxLUA_USE_wxPrint && wxUSE_PRINTING_ARCHITECTURE)
    { wxLua_wxDocManager_GetPageSetupDialogData1, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocManager_GetPageSetupDialogData1 },
#endif // ((wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_PRINTING_ARCHITECTURE)) && (wxLUA_USE_wxPrint && wxUSE_PRINTING_ARCHITECTURE)

#if ((wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_PRINTING_ARCHITECTURE)) && (wxLUA_USE_wxPrint && wxUSE_PRINTING_ARCHITECTURE)
    { wxLua_wxDocManager_GetPageSetupDialogData, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocManager_GetPageSetupDialogData },
#endif // ((wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_PRINTING_ARCHITECTURE)) && (wxLUA_USE_wxPrint && wxUSE_PRINTING_ARCHITECTURE)
};
static int s_wxluafunc_wxLua_wxDocManager_GetPageSetupDialogData_overload_count = sizeof(s_wxluafunc_wxLua_wxDocManager_GetPageSetupDialogData_overload)/sizeof(wxLuaBindCFunc);
...
wxLuaBindMethod wxDocManager_methods[] = {
    { "ActivateView", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_ActivateView, 1, NULL },
    ...
    { "Clear", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_Clear, 1, NULL },
    { "CloseDocument", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_CloseDocument, 1, NULL },
    ...
    { "CreateNewDocument", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_CreateNewDocument, 1, NULL },
    { "CreateView", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_CreateView, 1, NULL },
    { "DeleteTemplate", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_DeleteTemplate, 1, NULL },
    ...
    { "FindDocumentByPath", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_FindDocumentByPath, 1, NULL },

#if (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxLUA_USE_wxClassInfo)
    { "FindTemplate", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_FindTemplate, 1, NULL },
#endif // (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxLUA_USE_wxClassInfo)

    { "FindTemplateForPath", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_FindTemplateForPath, 1, NULL },
    { "FlushDoc", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_FlushDoc, 1, NULL },
    { "GetAnyUsableView", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_GetAnyUsableView, 1, NULL },
    ...
    { "GetDocumentManager", WXLUAMETHOD_METHOD|WXLUAMETHOD_STATIC, s_wxluafunc_wxLua_wxDocManager_GetDocumentManager, 1, NULL },
    ...
    { "GetHistoryFile", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_GetHistoryFile, 1, NULL },
...
#if (((wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_PRINTING_ARCHITECTURE)) && (wxLUA_USE_wxPrint && wxUSE_PRINTING_ARCHITECTURE))
    { "GetPageSetupDialogData", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_GetPageSetupDialogData_overload, s_wxluafunc_wxLua_wxDocManager_GetPageSetupDialogData_overload_count, 0 },
#endif // (((wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_PRINTING_ARCHITECTURE)) && (wxLUA_USE_wxPrint && wxUSE_PRINTING_ARCHITECTURE))
    ...
    { "MakeFrameTitle", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_MakeFrameTitle, 1, NULL },
    { "MakeNewDocumentName", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_MakeNewDocumentName, 1, NULL },
    { "MatchTemplate", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_MatchTemplate, 1, NULL },
    ...
    { "OnMRUFile", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnMRUFile, 1, NULL },
    { "OnOpenFileFailure", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnOpenFileFailure, 1, NULL },

#if (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_PRINTING_ARCHITECTURE)
    { "OnPageSetup", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnPageSetup, 1, NULL },
    { "OnPreview", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnPreview, 1, NULL },
    { "OnPrint", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnPrint, 1, NULL },
#endif // (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxUSE_PRINTING_ARCHITECTURE)

    { "OnRedo", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnRedo, 1, NULL },
    { "OnUndo", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnUndo, 1, NULL },
    { "OnUpdateDisableIfNoDoc", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnUpdateDisableIfNoDoc, 1, NULL },
    { "OnUpdateFileNew", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnUpdateFileNew, 1, NULL },
    { "OnUpdateFileOpen", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnUpdateFileOpen, 1, NULL },
    { "OnUpdateFileRevert", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnUpdateFileRevert, 1, NULL },
    { "OnUpdateFileSave", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnUpdateFileSave, 1, NULL },
    { "OnUpdateFileSaveAs", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnUpdateFileSaveAs, 1, NULL },
    { "OnUpdateRedo", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnUpdateRedo, 1, NULL },
    { "OnUpdateUndo", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_OnUpdateUndo, 1, NULL },
    { "RemoveDocument", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_RemoveDocument, 1, NULL },
    { "RemoveFileFromHistory", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_RemoveFileFromHistory, 1, NULL },
    { "SelectDocumentPath", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_SelectDocumentPath, 1, NULL },
    { "SelectDocumentType", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_SelectDocumentType, 1, NULL },
    { "SelectViewType", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocManager_SelectViewType, 1, NULL },
...
#if ((wxLUA_USE_wxFrame) && (wxLUA_USE_wxPointSizeRect)) && (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE)
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocParentFrame_constructor[] = { &wxluatype_wxDocManager, &wxluatype_wxFrame, &wxluatype_TNUMBER, &wxluatype_TSTRING, &wxluatype_wxPoint, &wxluatype_wxSize, &wxluatype_TINTEGER, &wxluatype_TSTRING, NULL };
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocTemplate_CreateDocument[] = { &wxluatype_wxDocTemplate, &wxluatype_TSTRING, &wxluatype_TINTEGER, NULL };
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocTemplate_CreateView[] = { &wxluatype_wxDocTemplate, &wxluatype_wxDocument, &wxluatype_TINTEGER, NULL };
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocTemplate_InitDocument[] = { &wxluatype_wxDocTemplate, &wxluatype_wxDocument, &wxluatype_TSTRING, &wxluatype_TINTEGER, NULL };
...
static int LUACALL wxLua_wxDocTemplate_InitDocument(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // long flags = 0
    long flags = (argCount >= 4 ? (long)wxlua_getintegertype(L, 4) : 0);
    // const wxString path
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocTemplate_SetFlags[] = { &wxluatype_wxDocTemplate, &wxluatype_TINTEGER, NULL };
...
#if (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxLUA_USE_wxClassInfo)
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocTemplate_constructor[] = { &wxluatype_wxDocManager, &wxluatype_TSTRING, &wxluatype_TSTRING, &wxluatype_TSTRING, &wxluatype_TSTRING, &wxluatype_TSTRING, &wxluatype_TSTRING, &wxluatype_wxClassInfo, &wxluatype_wxClassInfo, &wxluatype_TINTEGER, NULL };
...
static int LUACALL wxLua_wxDocTemplate_constructor(lua_State *L)
{
    ...
    long flags = (argCount >= 10 ? (long)wxlua_getintegertype(L, 10) : wxDEFAULT_TEMPLATE_FLAGS);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocument_Activate[] = { &wxluatype_wxDocument, NULL };
static int LUACALL wxLua_wxDocument_Activate(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocument_Activate[1] = {{ wxLua_wxDocument_Activate, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocument_Activate }};
//     void Activate();
static int LUACALL wxLua_wxDocument_Activate(lua_State *L)
{
    // get this
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocument_AlreadySaved[] = { &wxluatype_wxDocument, NULL };
static int LUACALL wxLua_wxDocument_AlreadySaved(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocument_AlreadySaved[1] = {{ wxLua_wxDocument_AlreadySaved, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocument_AlreadySaved }};
...
static int LUACALL wxLua_wxDocument_AlreadySaved(lua_State *L)
{
    ...
    wxDocument * self = (wxDocument *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocument);
    // call AlreadySaved
    bool returns = (self->AlreadySaved());
    // push the result flag
    lua_pushboolean(L, returns);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocument_DeleteContents[] = { &wxluatype_wxDocument, NULL };
static int LUACALL wxLua_wxDocument_DeleteContents(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocument_DeleteContents[1] = {{ wxLua_wxDocument_DeleteContents, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocument_DeleteContents }};
...
static int LUACALL wxLua_wxDocument_DeleteContents(lua_State *L)
{
    ...
    wxDocument * self = (wxDocument *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocument);
    // call DeleteContents
    bool returns = (self->DeleteContents());
    // push the result flag
    lua_pushboolean(L, returns);
...
#if (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxLUA_USE_wxDC)
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocument_Draw[] = { &wxluatype_wxDocument, &wxluatype_wxDC, NULL };
static int LUACALL wxLua_wxDocument_Draw(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocument_Draw[1] = {{ wxLua_wxDocument_Draw, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocument_Draw }};
//     virtual bool Draw(wxDC&);
static int LUACALL wxLua_wxDocument_Draw(lua_State *L)
{
    // wxDC arg1
    wxDC * arg1 = (wxDC *)wxluaT_getuserdatatype(L, 2, wxluatype_wxDC);
    // get this
    wxDocument * self = (wxDocument *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocument);
    // call Draw
    bool returns = (self->Draw(*arg1));
    // push the result flag
    lua_pushboolean(L, returns);
...
#endif // (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxLUA_USE_wxDC)
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocument_GetDocumentSaved[] = { &wxluatype_wxDocument, NULL };
static int LUACALL wxLua_wxDocument_GetDocumentSaved(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocument_GetDocumentSaved[1] = {{ wxLua_wxDocument_GetDocumentSaved, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocument_GetDocumentSaved }};
//     bool GetDocumentSaved() const;
static int LUACALL wxLua_wxDocument_GetDocumentSaved(lua_State *L)
{
    // get this
    wxDocument * self = (wxDocument *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocument);
    // call GetDocumentSaved
    bool returns = (self->GetDocumentSaved());
    // push the result flag
    lua_pushboolean(L, returns);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocument_GetViews1[] = { &wxluatype_wxDocument, NULL };
static int LUACALL wxLua_wxDocument_GetViews1(lua_State *L);
// static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocument_GetViews1[1] = {{ wxLua_wxDocument_GetViews1, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocument_GetViews1 }};
...
static int LUACALL wxLua_wxDocument_GetViews1(lua_State *L)
{
    ...
    wxDocument * self = (wxDocument *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocument);
    // call GetViews
    const wxObjectList* returns = (const wxObjectList*)&self->GetViews();
    // push the result datatype
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxObjectList);
...
static int LUACALL wxLua_wxDocument_GetViews(lua_State *L)
{
    ...
    wxDocument * self = (wxDocument *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocument);
    // call GetViews
    wxObjectList* returns = (wxObjectList*)&self->GetViews();
    // push the result datatype
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxObjectList);
...
{
    // bool mod
    bool mod = wxlua_getbooleantype(L, 2);
    // get this
    wxDocument * self = (wxDocument *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocument);
    // call Modify
    self->Modify(mod);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocument_NotifyClosing[] = { &wxluatype_wxDocument, NULL };
static int LUACALL wxLua_wxDocument_NotifyClosing(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocument_NotifyClosing[1] = {{ wxLua_wxDocument_NotifyClosing, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocument_NotifyClosing }};
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocument_OnChangeFilename[] = { &wxluatype_wxDocument, &wxluatype_TBOOLEAN, NULL };
static int LUACALL wxLua_wxDocument_OnChangeFilename(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocument_OnChangeFilename[1] = {{ wxLua_wxDocument_OnChangeFilename, WXLUAMETHOD_METHOD, 2, 2, s_wxluatypeArray_wxLua_wxDocument_OnChangeFilename }};
//     virtual void OnChangeFilename(bool notifyViews);
static int LUACALL wxLua_wxDocument_OnChangeFilename(lua_State *L)
{
    // bool notifyViews
    bool notifyViews = wxlua_getbooleantype(L, 2);
    // get this
    wxDocument * self = (wxDocument *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocument);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocument_OnCreate[] = { &wxluatype_wxDocument, &wxluatype_TSTRING, &wxluatype_TINTEGER, NULL };
...
{
    // long flags
    long flags = (long)wxlua_getintegertype(L, 3);
    // const wxString path
    const wxString path = wxlua_getwxStringtype(L, 2);
    // get this
    wxDocument * self = (wxDocument *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocument);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocument_Revert[] = { &wxluatype_wxDocument, NULL };
static int LUACALL wxLua_wxDocument_Revert(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocument_Revert[1] = {{ wxLua_wxDocument_Revert, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocument_Revert }};
//     virtual bool Revert();
static int LUACALL wxLua_wxDocument_Revert(lua_State *L)
{
    // get this
...
static int LUACALL wxLua_wxDocument_SetCommandProcessor(lua_State *L)
{
    ...
    wxCommandProcessor * proc = (wxCommandProcessor *)wxluaT_getuserdatatype(L, 2, wxluatype_wxCommandProcessor);
    // get this
    wxDocument * self = (wxDocument *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocument);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocument_SetDocumentSaved[] = { &wxluatype_wxDocument, &wxluatype_TBOOLEAN, NULL };
static int LUACALL wxLua_wxDocument_SetDocumentSaved(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocument_SetDocumentSaved[1] = {{ wxLua_wxDocument_SetDocumentSaved, WXLUAMETHOD_METHOD, 1, 2, s_wxluatypeArray_wxLua_wxDocument_SetDocumentSaved }};
...
static int LUACALL wxLua_wxDocument_SetDocumentSaved(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool saved = true
    bool saved = (argCount >= 2 ? wxlua_getbooleantype(L, 2) : true);
    // get this
    wxDocument * self = (wxDocument *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocument);
    // call SetDocumentSaved
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxDocument_constructor[] = { &wxluatype_wxDocument, NULL };
static int LUACALL wxLua_wxDocument_constructor(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocument_constructor[1] = {{ wxLua_wxDocument_constructor, WXLUAMETHOD_CONSTRUCTOR, 0, 1, s_wxluatypeArray_wxLua_wxDocument_constructor }};
...
static int LUACALL wxLua_wxDocument_constructor(lua_State *L)
{
    ...
    wxDocument * parent = (argCount >= 1 ? (wxDocument *)wxluaT_getuserdatatype(L, 1, wxluatype_wxDocument) : NULL);
    // call constructor
    wxDocument* returns = new wxDocument(parent);
    // push the constructed class pointer
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxDocument);
...
#if (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE)
// function overload table
static wxLuaBindCFunc s_wxluafunc_wxLua_wxDocument_GetViews_overload[] =
{
    { wxLua_wxDocument_GetViews1, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocument_GetViews1 },
    { wxLua_wxDocument_GetViews, WXLUAMETHOD_METHOD, 1, 1, s_wxluatypeArray_wxLua_wxDocument_GetViews },
};
static int s_wxluafunc_wxLua_wxDocument_GetViews_overload_count = sizeof(s_wxluafunc_wxLua_wxDocument_GetViews_overload)/sizeof(wxLuaBindCFunc);
...
wxLuaBindMethod wxDocument_methods[] = {
    { "Activate", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocument_Activate, 1, NULL },
    { "AddView", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocument_AddView, 1, NULL },
    { "AlreadySaved", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocument_AlreadySaved, 1, NULL },
    ...
    { "DeleteContents", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocument_DeleteContents, 1, NULL },

#if (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxLUA_USE_wxDC)
    { "Draw", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocument_Draw, 1, NULL },
#endif // (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE) && (wxLUA_USE_wxDC)
    ...
    { "GetDocumentSaved", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocument_GetDocumentSaved, 1, NULL },
...
#if (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE)
    { "GetViews", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocument_GetViews_overload, s_wxluafunc_wxLua_wxDocument_GetViews_overload_count, 0 },
#endif // (wxLUA_USE_MDI && wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE)
    ...
    { "NotifyClosing", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocument_NotifyClosing, 1, NULL },
    { "OnChangeFilename", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocument_OnChangeFilename, 1, NULL },
    ...
    { "Revert", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocument_Revert, 1, NULL },
    ...
    { "SetDocumentSaved", WXLUAMETHOD_METHOD, s_wxluafunc_wxLua_wxDocument_SetDocumentSaved, 1, NULL },
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxView_OnCreate[] = { &wxluatype_wxView, &wxluatype_wxDocument, &wxluatype_TINTEGER, NULL };
...
static int LUACALL wxLua_wxCommandProcessor_GetCommands(lua_State *L)
{
    ...
    wxCommandProcessor * self = (wxCommandProcessor *)wxluaT_getuserdatatype(L, 1, wxluatype_wxCommandProcessor);
    // call GetCommands
    wxObjectList* returns = (wxObjectList*)&self->GetCommands();
    // push the result datatype
    wxluaT_pushuserdatatype(L, returns, wxluatype_wxObjectList);
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxCommandProcessor_constructor[] = { &wxluatype_TINTEGER, NULL };
...
static int LUACALL wxLua_wxCommandProcessor_constructor(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // int maxCommands = -1
    int maxCommands = (argCount >= 1 ? (int)wxlua_getintegertype(L, 1) : -1);
    // call constructor
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxFileHistory_GetHistoryFile[] = { &wxluatype_wxFileHistory, &wxluatype_TINTEGER, NULL };
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxFileHistory_constructor[] = { &wxluatype_TINTEGER, &wxluatype_TNUMBER, NULL };
...
static int LUACALL wxLua_wxFileHistory_constructor(lua_State *L)
{
    ...
    // int maxFiles = 9
    int maxFiles = (argCount >= 1 ? (int)wxlua_getintegertype(L, 1) : 9);
    // call constructor
