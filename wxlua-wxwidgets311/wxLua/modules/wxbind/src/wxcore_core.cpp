...
static wxLuaArgType s_wxluatypeArray_wxLua_wxValidator_SuppressBellOnError[] = { &wxluatype_TBOOLEAN, NULL };
static int LUACALL wxLua_wxValidator_SuppressBellOnError(lua_State *L);
static wxLuaBindCFunc s_wxluafunc_wxLua_wxValidator_SuppressBellOnError[1] = {{ wxLua_wxValidator_SuppressBellOnError, WXLUAMETHOD_METHOD|WXLUAMETHOD_STATIC, 0, 1, s_wxluatypeArray_wxLua_wxValidator_SuppressBellOnError }};
...
static int LUACALL wxLua_wxValidator_SuppressBellOnError(lua_State *L)
{
    ...
    int argCount = lua_gettop(L);
    // bool suppress = true
    bool suppress = (argCount >= 1 ? wxlua_getbooleantype(L, 1) : true);
    // call SuppressBellOnError
...
wxLuaBindMethod wxValidator_methods[] = {
    ...
    { "SuppressBellOnError", WXLUAMETHOD_METHOD|WXLUAMETHOD_STATIC, s_wxluafunc_wxLua_wxValidator_SuppressBellOnError, 1, NULL },
...
#if ((wxLUA_USE_wxTextValidator) && (wxLUA_USE_wxValidator && wxUSE_VALIDATORS)) && (wxLUA_USE_wxArrayString)
...
#endif // ((wxLUA_USE_wxTextValidator) && (wxLUA_USE_wxValidator && wxUSE_VALIDATORS)) && (wxLUA_USE_wxArrayString)
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxTextValidator_SetStyle[] = { &wxluatype_wxTextValidator, &wxluatype_TINTEGER, NULL };
...
static wxLuaArgType s_wxluatypeArray_wxLua_wxTextValidator_constructor[] = { &wxluatype_TINTEGER, &wxluatype_wxLuaObject, NULL };
