...
#endif // ((wxLUA_USE_wxPointSizeRect) && (wxLUA_USE_wxValidator && wxUSE_VALIDATORS)) && (wxLUA_USE_wxMediaCtrl && wxUSE_MEDIACTRL)
...
#if (((wxLUA_USE_wxPointSizeRect) && (wxLUA_USE_wxValidator && wxUSE_VALIDATORS)) && (wxLUA_USE_wxMediaCtrl && wxUSE_MEDIACTRL))||(wxLUA_USE_wxMediaCtrl && wxUSE_MEDIACTRL)
// function overload table
...
#endif // (((wxLUA_USE_wxPointSizeRect) && (wxLUA_USE_wxValidator && wxUSE_VALIDATORS)) && (wxLUA_USE_wxMediaCtrl && wxUSE_MEDIACTRL))||(wxLUA_USE_wxMediaCtrl && wxUSE_MEDIACTRL)
