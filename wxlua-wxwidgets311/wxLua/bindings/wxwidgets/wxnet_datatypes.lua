-- ---------------------------------------------------------------------------
-- ../bindings/wxwidgets/wxnet_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(wxnet_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(wxnet_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(wxnet_preprocConditionTable) do
