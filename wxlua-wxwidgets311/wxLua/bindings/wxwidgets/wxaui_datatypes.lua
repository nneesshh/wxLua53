-- ---------------------------------------------------------------------------
-- ../bindings/wxwidgets/wxaui_datatypes.lua was generated by genwxbind.lua 
-- 
...
wxaui_dataTypeTable =
{
  ...
  wxAuiButtonId = {
    Condition = "wxLUA_USE_wxAUI && wxUSE_AUI",
    IsNumber = true,
    Name = "wxAuiButtonId",
    ValueType = "enum",
  },
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(wxaui_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(wxaui_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(wxaui_preprocConditionTable) do
