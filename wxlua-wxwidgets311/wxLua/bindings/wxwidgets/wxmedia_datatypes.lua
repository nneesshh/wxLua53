-- ---------------------------------------------------------------------------
-- ../bindings/wxwidgets/wxmedia_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(wxmedia_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(wxmedia_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(wxmedia_preprocConditionTable) do
