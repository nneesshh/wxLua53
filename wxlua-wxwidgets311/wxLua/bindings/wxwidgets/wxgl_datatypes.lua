-- ---------------------------------------------------------------------------
-- ../bindings/wxwidgets/wxgl_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(wxgl_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(wxgl_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(wxgl_preprocConditionTable) do
