-- ---------------------------------------------------------------------------
-- ../bindings/wxwidgets/wxhtml_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(wxhtml_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(wxhtml_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(wxhtml_preprocConditionTable) do
