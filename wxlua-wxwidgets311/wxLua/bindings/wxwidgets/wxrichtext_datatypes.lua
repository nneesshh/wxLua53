-- ---------------------------------------------------------------------------
-- ../bindings/wxwidgets/wxrichtext_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- ---------------------------------------------------------------------------
wxrichtext_preprocConditionTable =
{
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(wxrichtext_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(wxrichtext_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(wxrichtext_preprocConditionTable) do
