-- ---------------------------------------------------------------------------
-- ../bindings/wxwidgets/wxbase_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(wxbase_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(wxbase_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(wxbase_preprocConditionTable) do
