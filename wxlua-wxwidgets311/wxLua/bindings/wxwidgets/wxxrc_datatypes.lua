-- ---------------------------------------------------------------------------
-- ../bindings/wxwidgets/wxxrc_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(wxxrc_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(wxxrc_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(wxxrc_preprocConditionTable) do
