-- ---------------------------------------------------------------------------
-- ../bindings/wxlua_debugger/wxluadebugger_datatypes.lua was generated by genwxbind.lua 
-- 
...
wxluadebugger_dataTypeTable =
{
  ...
  ["wxIconBundle::FALLBACK"] = {
    Condition = "wxLUA_USE_wxIcon",
    IsNumber = true,
    Name = "wxIconBundle::FALLBACK",
    ValueType = "enum",
  },
  wxIconLocation = {
    IsNumber = false,
...
-- ---------------------------------------------------------------------------
wxluadebugger_preprocConditionTable =
{
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(wxluadebugger_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(wxluadebugger_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(wxluadebugger_preprocConditionTable) do
