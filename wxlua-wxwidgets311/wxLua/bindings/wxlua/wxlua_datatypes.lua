-- ---------------------------------------------------------------------------
-- ../bindings/wxlua/wxlua_datatypes.lua was generated by genwxbind.lua 
-- 
...
-- Cache the dataTypes
-- ---------------------------------------------------------------------------
    for k, v in pairs(wxlua_typedefTable) do
        typedefTable[k] = v
    end
    for k, v in pairs(wxlua_dataTypeTable) do
        dataTypeTable[k] = v
    end
    for k, v in pairs(wxlua_preprocConditionTable) do
